    ...
    return (
        <div className="main-container">
            <Head>
                ...
                <meta name="description" content="India's leading one-way intercity cab service provider." />
                ...
                <section className="content-section why-yatri-section">
                    ...
                    <div className="why-yatri-features">
                        ...
                        <div className="feature-item">
                            ...
                            <div><h4>FAST RESPONSE TIME</h4><p>Experience The Best Car Rental Service With Driver For Local Or Outstation Trips. Enjoy Prompt Response Times And Seamless Car Hire Service, Ensuring You Get On The Road Quickly.</p></div>
                        </div>
                        <div className="feature-item">
                            <i className="fas fa-car"></i>
                            <div><h4>VAST FLEET</h4><p>We Offer A Wide Range Of Rental Cars Including Sedans, SUVs, MUVs, Premium Sedans, And Tempo Travellers To Meet All Your Car Hire Needs.</p></div>
                        </div>
                        <div className="feature-item">
                            <i className="fas fa-mobile-alt"></i>
                            <div><h4>EASY TO ORDER</h4><p>Easily Book A Cab Online Through Our User-Friendly Website, Mobile Application, Or By Calling Our Customer Support Team.</p></div>
                        </div>
                        <div className="feature-item">
                            <i className="fas fa-dollar-sign"></i>
                            <div><h4>GREAT TARIFFS</h4><p>Rent A Car At The Lowest Rates! Our Car Hire Tariffs Are Highly Competitive Compared To Other Operators. Book Online Cabs At The Best Prices With Yatri Car Rental.</p></div>
                        </div>
                    </div>
                </section>
